...
class BayesianTubeModel:
    ...
    def build_model(self):
        ...
        with pm.Model(coords=coords) as self.model:
            ...
            # Use the underlying Normal distribution (not TruncatedNormal) for the survival function,
            # since TruncatedNormal's CDF = 1.0 at the upper bound would result in log(0) = -inf.
            # We use log1mexp and clip to -30 for numerical stability to avoid NUTS divergences.
    ...
    def _flag_outliers_from_trace(self):
        ...
        lower_bound = mu_pred - 1.96 * obs_sigma
        upper_bound = mu_pred + 1.96 * obs_sigma
